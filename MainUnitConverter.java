...
public class Main {
    public static void main(String[] args) {
      System.out.println("Καλώς Όρισες χρήστη στην \nΕνοποιημένη Εφαρμογή Μετατροπής Μονάδων!");
      System.out.println("+---------------------------------------------------------------------+");
      ...
      System.out.println("\nΚαλώς Όρισες χρήστη στο \nΕνοποιημένη Εφαρμογή Μετατροπής Μονάδων!");
      System.out.println("+---------------------------------------------------------------------+");
      System.out.println("|1. Διάσταση\t2. Ενέργεια\t3. ΕπιστήμηΥπολογιστών                |\n|4. Κίνηση\t5. Μηχανική\t6. Νόμισμα                            |\n|7. Ώρα                                                               |");
      System.out.println("+---------------------------------------------------------------------+");
